...
public class OmanArabBankFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View root = inflater.inflate(R.layout.fragment_oman_arab_bank, container, false);
        getActivity().setTitle("Oman Arab Bank");
        ...
        liveChatCardView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                sendIntent.putExtra("sms_body", "Hello Oman Arab Bank");
