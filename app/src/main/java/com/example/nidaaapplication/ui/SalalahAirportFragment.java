...
public class SalalahAirportFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View root = inflater.inflate(R.layout.fragment_salalah_airport, container, false);
        getActivity().setTitle("Salalah Airport");
        ...
        liveChatCardView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                sendIntent.putExtra("sms_body", "Hello Salalah Airport");
