...
public class MuscatInternationAirportFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View root = inflater.inflate(R.layout.fragment_muscat_inter_airport, container, false);

        getActivity().setTitle("Muscat Inter Airport");
        ...
        liveChatCardView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                sendIntent.putExtra("sms_body", "Hello Muscat International Airport");
