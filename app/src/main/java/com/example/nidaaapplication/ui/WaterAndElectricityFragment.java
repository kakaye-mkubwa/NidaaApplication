...
public class WaterAndElectricityFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View root = inflater.inflate(R.layout.fragment_water_electricity, container, false);
        getActivity().setTitle("Water and Electrity");
        ...
        liveChatCardView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                sendIntent.putExtra("sms_body", "Hello Water Company");
